...
from app.controllers.water_intake_controller import \
    router as water_intake_router
# from app.controllers.utility_controller import router as utility_router  # Deprecated
...
# app.include_router(utility_router)  # Deprecated
